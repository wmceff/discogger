...
class QueriesControllerTest < ActionController::TestCase
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post :create, query: { completed_page: @query.completed_page, query_string: @query.query_string, total_pages: @query.total_pages }
    end
  ...
  test "should update query" do
    patch :update, id: @query, query: { completed_page: @query.completed_page, query_string: @query.query_string, total_pages: @query.total_pages }
    assert_redirected_to query_path(assigns(:query))
  end
